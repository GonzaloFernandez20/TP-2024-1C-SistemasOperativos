...
void init(void){
    kernel_log = iniciar_logger(NOMBRE_ARCHIVO_LOG, "KERNEL", 1, LOG_LEVEL_DEBUG);                
    kernel_log_debugg = iniciar_logger(NOMBRE_ARCHIVO_LOG_DEBUG, "KERNEL", 1, LOG_LEVEL_DEBUG);
